...
# MAGIC %sql
# MAGIC CREATE SCHEMA IF NOT EXISTS dev.stepright;

# COMMAND ----------

# MAGIC %sql
# MAGIC SHOW SCHEMAS in dev LIKE 'stepright'

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE VOLUME IF NOT EXISTS dev.stepright.landing

# COMMAND ----------

landing_root = f"/Volumes/dev/stepright/landing"
